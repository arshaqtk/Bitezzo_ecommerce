...
function Signup() {
  ...
  return (
    <>
      <div className="flex justify-center items-center min-h-screen  bg-cover bg-center p-4 bg-gray-700 ">
        <div className="bg-white/20 backdrop-blur-md border border-white/40 shadow-lg rounded-xl p-8 max-w-md w-full">
