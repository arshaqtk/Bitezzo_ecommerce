...
function Products() {
  ...
  <div className="hidden sm:block bg-[#FAF1E6] p-8 rounded-xl shadow-md">
    <div className="flex flex-wrap gap-4 justify-center">
      <button
        className="px-6 py-3 bg-white/70 border border-gray-200 text-gray-800 font-medium rounded-lg shadow-sm hover:bg-gray-100 transition cursor-pointer"
