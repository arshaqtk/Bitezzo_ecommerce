...
const handleStatusChange = (orderId, newStatus,userId) => {
  ...
  return (
    <div className="min-h-screen bg-[#F5F7FA] p-8">
      <h1 className="text-2xl font-bold text-violet-900 mb-6">Order Details</h1>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        {/* Shipping Address */}
        <div className="bg-white rounded-2xl shadow-md p-6">
          <h2 className="text-lg font-semibold text-violet-900 mb-4">Shipping Address</h2>
        ...
        {/* Order Info */}
        <div className="bg-white rounded-2xl shadow-md p-6">
  <h2 className="text-lg font-semibold text-violet-900 mb-4">Order Information</h2>
  ...
  <div className="mt-4">
    ...
    >
      ...
      {/* Products */}
      <div className="bg-white rounded-2xl shadow-md p-6">
        <h2 className="text-lg font-semibold text-violet-900 mb-4">Products</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          {order.products.map((product) => (
            <div key={product.productId} className="border rounded-xl p-4 hover:shadow-md transition">
              ...
              />
              <h3 className="text-md font-medium text-violet-900">{product.productName}</h3>
